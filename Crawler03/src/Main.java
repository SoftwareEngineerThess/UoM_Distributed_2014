...
/*		PETROOO odigies
		...
		1- GIT PULL: Ferneis ta arxeia sto pc sou me to git. URL "https://github.com/SoftwareEngineerThess/UoM_Distributed_2014.git". workspace tou git o fakelos "UoM_Distributed_2014.git" (dimiourgise ton an den yparxei) mesa sto workspace tou eclipse
			(to allaksa epidi egine kati periergo kai sbistike to master apo to origin, kai gia na min mpleksw brika neo onoma)
		2- Apo to eclipse sbineis ta arxeia tou project
		3- File/import project kai dialegeis to fakelo "workspace\UoM_Distributed_2014.git\Crawler03" pou efere to Git (an exeis tsekarismeno to copy project into workspace ksetsekarise to)
